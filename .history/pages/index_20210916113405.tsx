      ...
      {posts.map(post => {
        return (
          <Content
            ...
            slug={post.slug}
            main={true}
          ></Content>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aperiam maiores nihil debitis excepturi molestias eaque at! Quisquam, maxime velit? Aperiam exercitationem fugit nulla nam nostrum! Maxime tenetur voluptas ut est?
        );
      })}
    </>
  );
...
export const getStaticProps: GetStaticProps = async () => {
  const data = await fetch('/.netlify/functions/express/posts', {method:'GET'})
  return {
    props: {
      posts: [
        {
